...
<div class="card shadow mt-3 mx-5">
    ...
    <div class="card-body">
        <form action="{{ route('data-perkembangan-siswa.store') }}" method="post">
            @csrf
            ...
            <div class="form-group">  
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control @error('tanggal_latihan') is-invalid @enderror" id="tanggal_latihan" name="tanggal_latihan" value="{{ old('tanggal_latihan') }}" required>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('keterangan') is-invalid @enderror" name="keterangan" id="keterangan" rows="3" required placeholder="Keterangan">{{ old('keterangan') }}</textarea>
                    @error('keterangan')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
