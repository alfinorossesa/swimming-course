        ...
        <form action="{{ route('data-informasi.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('judul_info') is-invalid @enderror" id="judul_info" name="judul_info" placeholder="Judul Informasi" value="{{ old('judul_info') }}" required>
                    @error('judul_info')
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('detail_info') is-invalid @enderror" name="detail_info" id="detail_info" rows="3" required placeholder="Detail Informasi">{{ old('detail_info') }}</textarea>
                    @error('detail_info')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
